...
//  CowtownApp
//
//  Created by Robert Vera on 6/22/18.
...
class GuestPlayer: Person {
    ...
    init(firstName: NSString, lastName: NSString, dateOfBirth: NSDate, age: Int, gender: NSString, address: NSString) {
    ...
    init(firstName: NSString, middleName: NSString, lastName: NSString, address: NSString, dateOfBirth: NSDate
